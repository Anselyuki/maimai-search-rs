...
from src.libraries.tool import hashQQ
...
TodayMaimaiDX = on_command('今日舞萌', aliases={'今日mai'})


@TodayMaimaiDX.handle()
async def _(event: Event, message: Message = CommandArg()):
    ...
    await TodayMaimaiDX.finish(Message([MessageSegment("text", {"text": s})] + song_txt(music)))
